...
import {FiHome,FiUsers,FiCalendar,FiDollarSign,FiBarChart2,FiSettings,FiMessageSquare,FiUser,FiClipboard,FiPackage,FiTarget,FiAward,FiDatabase,FiGlobe} from 'react-icons/fi'
    ...
    switch (profile?.role) {
      ...
      case 'admin': 
        return [ 
          ...
          {name: 'Platform',href: '/platform-management',icon: FiGlobe},
      ...
      case 'trainer': 
        return [ 
          ...
          {name: 'Platform',href: '/platform',icon: FiGlobe}
        ] 
      case 'parent': 
        return [ 
          ...baseItems,
      ...
      default: 
        return [...baseItems,{name: 'Platform',href: '/platform',icon: FiGlobe}]
    }
  }
